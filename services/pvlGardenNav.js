...
export function buildGardenPvlStudentNav() {
    return [
        ...
        { type: 'item', key: 'pvl-st-prac', label: 'Календарь', iconKey: 'calendar', route: '/student/practicums' },
...
export function buildGardenPvlMentorNav() {
    return [
        ...
        { type: 'item', key: 'pvl-men-prac', label: 'Календарь', iconKey: 'calendar', route: '/mentor/practicums' },
...
export function buildGardenPvlAdminNav() {
    return [
        ...
        { type: 'item', key: 'pvl-adm-prac', label: 'Календарь', iconKey: 'calendar', route: '/admin/practicums' },
