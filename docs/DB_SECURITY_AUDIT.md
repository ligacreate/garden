...
> ⚠️ **Снимок состояния на 2026-05-02**, до старта SEC-001 миграции.
>
> Многое из того, что в этом документе описано как «нужно сделать»,
> уже выполнено в фазах SEC-001 (2026-05-02 — 2026-05-04, миграции
> phase 16-19). В частности устарели:
> - Раздел про «pvl_* таблицы без RLS» — RLS включён на всех, 90+
>   policies, helper `is_mentor_for(uuid)` SECURITY DEFINER.
> - Шаг 2.5 «спроектировать policies» — выполнен.
> - Гипотеза «фронт не пишет в DB, работает на cloneSeedData(seed)» —
>   опровергнута (ARCH-002, 2026-05-04: 48 submissions с реальными
>   ответами в `pvl_student_homework_submissions.payload`).
>
> **Актуальное состояние** см.:
> - `plans/BACKLOG.md` → раздел «История» (записи за 2026-05-02,
>   2026-05-03, 2026-05-04)
> - `docs/PVL_RECONNAISSANCE.md` раздел 2.4 (обновлён 2026-05-04 —
>   как фактически назначается ментор)
> - `migrations/2026-05-0[2-4]_phase1[6-9]_*.sql` — применённые
>   миграции SEC-001
>
> Документ остаётся как исторический artifact для понимания
> исходного состояния, с которого стартовала SEC-001.
